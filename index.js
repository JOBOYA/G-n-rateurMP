...
//Characters of alphabet(a-z/Az), numbers(0-9) and Symbols($&[]...)
let allCharacters = "abcdefghijklmnopqrstuvwyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789^!$%&|[](){}:;.,*+-#@<>~";
...
const generatePassword = () =>{
    ...
    //for loo will run till rangeInput value
